...
title: "Potential of Human flow (general graph case)" output: rmarkdown::html_vignette vignette: \> %\VignetteIndexEntry{PotentialInTokyo} %\VignetteEngine{knitr::rmarkdown} %\VignetteEncoding{UTF-8} ---Z
...
```{r}
s = HodgePotentialHumanFlow::scalar_potential_on_graph(netflow_selected, num_samples = 1e6)
```
