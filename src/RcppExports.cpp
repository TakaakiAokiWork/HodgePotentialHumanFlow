...
// pontential_on_graph
List pontential_on_graph(StringVector& vertex1, StringVector& vertex2, NumericVector& weight, NumericVector& netflow_R, StringVector& unique_geozomes, size_t num_samples, unsigned long int seed);
RcppExport SEXP _HodgePotentialHumanFlow_pontential_on_graph(SEXP vertex1SEXP, SEXP vertex2SEXP, SEXP weightSEXP, SEXP netflow_RSEXP, SEXP unique_geozomesSEXP, SEXP num_samplesSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    ...
    rcpp_result_gen = Rcpp::wrap(pontential_on_graph(vertex1, vertex2, weight, netflow_R, unique_geozomes, num_samples, seed));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_HodgePotentialHumanFlow_pontential_on_graph", (DL_FUNC) &_HodgePotentialHumanFlow_pontential_on_graph, 7},
    {NULL, NULL, 0}
};
